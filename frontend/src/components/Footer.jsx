  ...
  return (
    <div className='footerCont'>
        ...
        <div className="socialIcons">
            <img src="/assets/Insta.png" width="60px" alt="" />
            <img src="/assets/LinkedIn logo.webp" width="45px" alt="" />
            <img src="/assets/github logo.webp" width="35px" alt="" />
            <img src="/assets/facebook_logo.png" width="50px" alt="" />
        </div>
        </div>
